...
$string['csprecorduser'] = 'Record user violation data';
$string['csprecorduserhelp'] = 'Record counts of each user causing a CSP violation. Note: this will log every user that visits a page with embedded content that causes a CSP violation.';
