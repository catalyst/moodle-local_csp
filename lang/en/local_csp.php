...
$string['cspsettingsinfo'] = '<p>CSP works through adding a special HTTP response header to every Moodle page. Modern browsers, when they see this header, are able to perform certain actions e.g. block insecure content on such pages. Please read more about CSP <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP">here</a>.</p><p>HTTP response header types:<br /><span style="color:#00acdf">Content-Security-Policy-Report-Only</span> monitor and report CSP violations.<br /><span style="color:#00acdf">Content-Security-Policy</span> enforce browsers to follow CSP directives, e.g. block loading insecure content.</p><p>If you leave any of these settings blank CSP headers will not be used.</p>';
...
$string['cspheaderreporting'] = 'Content-Security-Policy-Report-Only';
$string['cspheaderreportingdefault'] = 'Content-Security-Policy-Report-Only: default-src https:; report-uri {$a}';
$string['cspheaderenforcing'] = 'Content-Security-Policy';
$string['cspheaderenforcingdefault'] = 'Content-Security-Policy: default-src https:;';
